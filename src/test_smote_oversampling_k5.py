...
for data in keel_data:
    ...
    csv_export_file_name = "../results/smote_oversampling_k5/data-naive_bayes.csv"
    output_csv = open(csv_export_file_name, "a")
    confusion_matrix_plot_file_name = "../results/smote_oversampling_k5/confusion_matrix/%s-%s.%s" % (
        data.file_name, "naive_bayes", "png")
    class_distribution_plot_file_name = "../results/smote_oversampling_k5/class_distribution/%s-%s.%s" % (
        data.file_name, "naive_bayes", "png")
...
for data in keel_data:
    # initialize file names and params
    csv_export_file_name = "../results/smote_oversampling_k5/data-random_forest.csv"
    output_csv = open(csv_export_file_name, "a")
    confusion_matrix_plot_file_name = "../results/smote_oversampling_k5/confusion_matrix/%s-%s.%s" % (
...
for data in keel_data:
    # initialize file names and params
    csv_export_file_name = "../results/smote_oversampling_k5/data-decision_tree.csv"
    output_csv = open(csv_export_file_name, "a")
    confusion_matrix_plot_file_name = "../results/smote_oversampling_k5/confusion_matrix/%s-%s.%s" % (
